...
export default function Certifications() {
  ...
  const featuredCertifications = [
    ...
    {
      category: 'Specialized Skills Certification',
      icon: '🎯',
      count: 4,
  ...
  return (
    <section id="certifications" className="bg-skills text-gray-900 py-24 px-6 md:px-12">
      ...
      <div className="absolute inset-0 overflow-hidden opacity-15">
        <div className="absolute top-1/4 right-1/4 w-80 h-80 bg-gradient-to-br from-purple-200 to-pink-200 rounded-full mix-blend-multiply filter blur-3xl animate-blob"></div>
        <div className="absolute bottom-1/4 left-1/4 w-64 h-64 bg-gradient-to-br from-indigo-200 to-blue-200 rounded-full mix-blend-multiply filter blur-3xl animate-blob animation-delay-2000"></div>
      </div>
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          <div className="grid md:grid-cols-4 gap-8 text-center">
            ...
            <div className="bg-gradient-to-r from-purple-50 to-pink-50 p-6 rounded-2xl border border-purple-200">
              <div className="text-4xl mb-2">⭐</div>
              <div className="text-3xl font-black text-purple-700 mb-1">4</div>
            ...
            <div className="bg-gradient-to-r from-amber-50 to-yellow-50 p-6 rounded-2xl border border-amber-200">
              <div className="text-4xl mb-2">📈</div>
              <div className="text-3xl font-black text-amber-700 mb-1">2024</div>
              <div className="text-amber-600 font-semibold">Latest Achievement</div>
            </div>
          </div>
        </motion.div>
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          ...
                          <div className="flex items-center space-x-4 text-xs">
                            ...
                            {cert.provider && (
                              <span className="text-gray-500">• {cert.provider}</span>
                            )}
                          </div>
                        </div>
                      </div>
        ...
        >
          <Link 
            href="/certifications"
            className="inline-flex items-center px-10 py-5 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-bold text-xl rounded-xl transition-all duration-300 transform hover:scale-105 light-shadow-xl hover:shadow-2xl"
          >
