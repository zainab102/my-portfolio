...
export default function Projects() {
  ...
  const featuredProjects = [
    ...
    {
      title: 'Zentrix Media by ZT',
      description: 'Business website for Zentrix Media by ZT, where I serve as CEO and Founder.',
      category: 'Web Development',
      tech: ['Next.js', 'React', 'Vercel'],
      githubLink: githubSearchLink('zentrix media by zt'),
      demoLink: 'https://zentrixmediabyzt.vercel.app',
      status: 'Completed',
      image: 'zentrix-media-website',
    ...
    },
    {
      ...
      description: 'Expense tracking tool for budgeting and category-based monitoring.',
      category: 'Data Analytics',
      tech: ['Python', 'Dash', 'Plotly', 'Pandas'],
      githubLink: githubSearchLink('expense tracker'),
    ...
    },
    {
      ...
      description: 'Spending analysis tool to track patterns and optimize personal finance decisions.',
      category: 'Data Analytics',
