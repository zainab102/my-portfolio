  ...
  const contactMethods = [
    {
      ...
      contact: 'tariqzainab1190@gmail.com',
      link: 'mailto:tariqzainab1190@gmail.com',
                    ...
                    >
                      <div className="flex items-center">
                        ...
                        <div className="ml-4 flex-1">
                          <h4
                            className={`text-lg font-black ${method.textColor} mb-1`}
                          >
                            {method.title}
                          </h4>
                          ...
                          <p
                            className={`font-bold ${method.textColor} text-sm`}
                          >
                            {method.contact}
                          </p>
                        </div>
