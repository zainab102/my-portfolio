...
export default function BlogsPreview({ limit = 3 }) {
  ...
  const blogCategories = [
    { name: 'Tech Insights', icon: '💻', count: 8, color: 'blue' },
    { name: 'Personal Growth', icon: '🌱', count: 5, color: 'green' },
    { name: 'Industry Trends', icon: '📈', count: 3, color: 'purple' }
  ];
          ...
          <>
            ...
            >
              ...
              <div className="flex flex-wrap gap-4 justify-center">
                {[
                  { name: 'React Development', icon: '⚛️', posts: 5 },
                  { name: 'AI & Machine Learning', icon: '🤖', posts: 3 },
                  { name: 'Career Growth', icon: '📈', posts: 4 },
