...
export default function Projects() {
  ...
  const projects = [
    ...
    {
      title: 'Zentrix Media by ZT Website',
      description: 'Official business website for Zentrix Media by ZT, led by the founder and CEO.',
      category: 'Web Development',
      tech: ['Next.js', 'React', 'Vercel'],
      demoLink: 'https://zentrixmediabyzt.vercel.app',
      status: 'Completed',
    ...
    // Web Development Projects
    {
      ...
      demoLink: 'https://video-platform-gold.vercel.app',
      status: 'Completed',
    ...
    },
    {
      ...
      demoLink: 'https://my-todo-app-lime-sigma.vercel.app',
      status: 'Completed',
    ...
    {
      title: 'Terminal Python Game',
      description: 'Terminal-based Python game focused on loops and interaction flow',
      category: 'Game Development',
      tech: ['Python', 'Random Module'],
      demoLink: 'https://python-game-orcin.vercel.app',
      status: 'Completed',
    ...
    },
    {
      ...
      description: 'Randomized number game with user input and logic handling',
      category: 'Game Development',
      tech: ['Python'],
      demoLink: 'https://random-number-game-gamma.vercel.app',
      status: 'Completed',
    ...
    // Python Projects
    {
      ...
      tech: ['Python', 'Tkinter'],
      demoLink: 'https://vocabulary-app-chi.vercel.app',
      status: 'Completed',
    ...
    },
    {
      ...
      category: 'Python Projects',
      tech: ['Python', 'qrcode'],
      demoLink: 'https://qr-code-generator-eta-sandy.vercel.app',
      status: 'Completed',
      bgColor: 'from-blue-50 to-cyan-50',
      borderColor: 'border-blue-200',
      textColor: 'text-blue-900',
    ...
    },
    {
      ...
      demoLink: 'https://expense-tracker-two-rho-38.vercel.app',
      status: 'Completed',
      bgColor: 'from-amber-50 to-yellow-50',
      borderColor: 'border-amber-200',
      textColor: 'text-amber-900',
    ...
    // AI & ML Projects
    {
      ...
      demoLink: 'https://conversational-agent-black.vercel.app',
      status: 'Completed',
      bgColor: 'from-purple-50 to-indigo-50',
      borderColor: 'border-purple-200',
      textColor: 'text-purple-900',
    ...
    {
      title: 'Autonomous Task-Driven AI Assistant',
      description: 'Task-driven autonomous assistant',
      category: 'AI & ML',
      tech: ['Python', 'AI', 'Automation'],
      demoLink: 'https://autonomous-task-driven-ai-assistant.vercel.app',
      status: 'Completed',
      bgColor: 'from-blue-50 to-cyan-50',
      borderColor: 'border-blue-200',
      textColor: 'text-blue-900',
    ...
    },
    {
      ...
      demoLink: 'https://ai-powered-resume-feedback-generato.vercel.app',
      status: 'Completed',
      bgColor: 'from-green-50 to-emerald-50',
      borderColor: 'border-green-200',
      textColor: 'text-green-900',
    ...
    },
    {
      ...
      demoLink: 'https://spending-tracker-sepia.vercel.app',
      status: 'Completed',
      bgColor: 'from-orange-50 to-rose-50',
      borderColor: 'border-orange-200',
      textColor: 'text-orange-900',
